...
- P2-01 through P2-10 are complete.
...
- [x] Inspect the existing MR detail layout, diff APIs, discussion
  presentation, comment composer ownership, response cache, account/session
  boundaries, and iOS 26 Liquid Glass usage.
- [x] Before writing production code, create
  `docs/P2_10_ENGINEERING_PLAN.md`. Document the REST and GraphQL contracts,
